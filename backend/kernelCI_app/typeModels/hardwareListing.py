...
from kernelCI_app.typeModels.commonDetails import BuildStatusCount, TestStatusCount
...
class HardwareItem(BaseModel):
    ...
    boot_status_summary: TestStatusCount
    build_status_summary: BuildStatusCount
