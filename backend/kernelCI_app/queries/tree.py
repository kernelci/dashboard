...
def get_tree_listing_data(origin: str, interval_in_days: int) -> Optional[list[dict]]:
    ...
    #
    # The JOIN FTC with IS NOT DISTINCT FROM is necessary because the tree names can be NULL,
    # in which case a simple WHERE (tree_name, git_commit_hash) IN FTC wouldn't work
