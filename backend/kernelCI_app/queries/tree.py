    ...
    *,
    ...
    if rows is None:
        ...
        tree_name_full_clause = (
            "AND " + checkout_clauses.get("tree_name_clause")
            if checkout_clauses.get("tree_name_clause")
            else ""
        )
        git_url_full_clause = (
            "AND " + checkout_clauses.get("git_url_clause")
            if checkout_clauses.get("git_url_clause")
            else ""
        )
