...
class TestGetCurrentRowData:
    @patch("kernelCI_app.helpers.treeDetails.handle_environment_misc")
    @patch("kernelCI_app.helpers.treeDetails.env_misc_value_or_default")
    @patch("kernelCI_app.helpers.treeDetails.extract_error_message")
    @patch("kernelCI_app.helpers.treeDetails.is_status_failure")
    @patch("kernelCI_app.helpers.treeDetails.handle_build_misc")
    def test_get_current_row_data(
        self,
        mock_handle_build_misc,
        ...
        mock_handle_build_misc.return_value = {"platform": "x86_64"}
...
class TestCallBasedOnCompatibleAndMiscPlatform:
    @patch("kernelCI_app.helpers.treeDetails.build_misc_value_or_default")
    def test_call_based_on_compatible_and_misc_platform_with_compatible(
        self, mock_build_misc_value
    ):
        """Test call_based_on_compatible_and_misc_platform with compatible environment."""
        mock_build_misc_value.return_value = {"platform": "x86_64"}
