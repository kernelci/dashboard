...
from kernelCI_app.helpers.filters import increment_test_issue_condition, test_issue_filter_condition
...
class TreeDetails(View):
    ...
    def __processBootsTest(self, currentRowData):
        ...
        if (
            ...
            or test_issue_filter_condition(
        ...
        tab_condition = increment_test_issue_condition(
    ...
    def __processNonBootsTest(self, currentRowData):
        ...
        tab_condition = increment_test_issue_condition(issue_id, incident_test_id)
