...
export const possibleTabValidator = z
  .enum(possibleTabs)
  .catch('treeDetails.boots');

const possibleTableFilter = ['error', 'success', 'all'] as const;

export const tableFilterValidator = z.enum(possibleTableFilter).catch('all');

export type TableFilter = z.infer<typeof tableFilterValidator>;
