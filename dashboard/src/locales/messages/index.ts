...
export const messages = {
  [LOCALES.EN_US]: {
    ...
    'commitChart.bootsHistory': 'Boots History',
    'commitChart.buildsHistory': 'Builds History',
    'commitChart.failedBoots': 'Failed boots',
    'commitChart.inconclusiveBoots': 'Inconclusive Boots',
    'commitChart.inconclusiveBuilds': 'Inconclusive Builds',
    'commitChart.invalidBuilds': 'Failed builds',
    'commitChart.successBoots': 'Success boots',
    'commitChart.testsFailed': 'Failed tests',
    'commitChart.testsHistory': 'Tests History',
    'commitChart.testsInconclusive': 'Inconclusive tests',
    'commitChart.testsSuccess': 'Success tests',
    'commitChart.validBuilds': 'Success builds',
